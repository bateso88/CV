...
| **[My Website](https://github.com/bateso88/portfolio)**  | A website I built to showcase some of my projects and my recent travels (see [here](https://nameless-ridge-90074.herokuapp.com/)). I built this because I wanted to learn how to create a slick-looking React-based app. I also wanted to learn how to build an image slider for a potential upcoming project. | React, JavaScript           |
